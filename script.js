const data = [
    ...
    { name: "Ananya", age: 27, profession: "admin" },
  ];
  ...
  function concatenateArray() {
    let dummyArray = [
        { name: "Shweta", age: 30, profession: "designer" },
        { name: "Kashish", age: 25, profession: "developer" },
    ];
  ...
  // 9. Update Profession
  function updateRahulProfession() {
    let Rahul = data.find(dev => dev.name.toLowerCase() === 'Rahul');
    if (Rahul) {
        Rahul.profession = 'manager';
        console.log("Rahul's profession updated to 'manager'");
    }
  }
